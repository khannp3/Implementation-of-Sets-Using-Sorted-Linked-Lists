...
void testSLLSetIntArray_new() {
        ...
        int arr[] = {8, 9, 4, 2, 1}; // this list

        SLLSet listObj2 = SLLSet(arr,5);
        string expectedSet = "8, 9, 4, 2, 1";
        int expectedSize = 5;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testCopy_new() {
		...
		SLLSet copied = listObj2.copy();
        copied.add(100);
        string expectedObj2 = "1, 2, 12, 7, 8";
        string expectedCopied = "1, 2, 12, 7, 8, 60";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
void testIsInFalse_new() {

    int arr[] = {6, 1, 3, 4, 7}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
...
void testAdd5() {
    ...
    int arr[] = {4, 3, 5, 9, 2, 1, 8 }; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

        int notadd = 0;


        string expectedObj2 = "4, 3, 5, 9, 2, 1, 8, 0";
...
void testUnion5() {
        // test union
    int arr[] = {5, 6, 1, 4, 2}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
        int uni2[] = {0, 4, 2}; // for testing union
        SLLSet listObj7 = SLLSet(uni2,3);
        SLLSet listObj8 = listObj2.setUnion(listObj7);

        string expected = "0, 5, 6, 1, 4, 2";
        int expectedSize = 6;
...
void testDifference5() {
    ...
    int arr[] = {3, 2, 4, 9, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

        SLLSet listObj17 = SLLSet();
        SLLSet listObj18 = listObj2.difference(listObj17);

        string expected = "2, 2, 4, 9, 8";
        int expectedSize = 5;
...
bool runAllTests(int argc, char const *argv[]) {
    ...
    s.push_back(CUTE(testIsInFalse_new));
